...
import com.carlariela.universidad.universidad_backend.servicios.contratos.PabellonDAO;
...
@Component
@Order(1) // pone un orden de ejecución en el caso de tener múltiples implementaciones de CommandLineRunner.
